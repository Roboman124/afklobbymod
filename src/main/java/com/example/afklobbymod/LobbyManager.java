...
public class LobbyManager {
    ...
    public boolean sendToLobby(ServerPlayerEntity player, PlayerAfkState state) {
        ...
        player.teleport(lobbyWorld, lobbyX, lobbyY, lobbyZ, state.originalYaw, state.originalPitch);
    ...
    public boolean returnPlayer(ServerPlayerEntity player, PlayerAfkState state) {
        ...
        player.teleport(original, state.originalX, state.originalY, state.originalZ, state.originalYaw, state.originalPitch);
        state.resetReturn();
    ...
    public boolean teleportToStage(ServerPlayerEntity player) {
        ...
        player.teleport(stageWorld, stageX, stageY, stageZ, player.getYaw(), player.getPitch());
        return true;
    }
